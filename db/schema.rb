...
ActiveRecord::Schema.define(version: 20_210_325_091_636) do
  ...
  create_table 'friendly_id_slugs', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
  ...
  create_table 'spree_adjustment_reasons', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                           force: :cascade do |t|
    t.string 'name'
    t.string 'code'
  ...
  create_table 'spree_adjustments', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
  ...
  create_table 'spree_calculators', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
    t.string 'type'
  ...
  create_table 'spree_credit_cards', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                     force: :cascade do |t|
    t.string 'month'
    t.string 'year'
    t.string 'cc_type'
  ...
  create_table 'spree_customer_returns', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                         force: :cascade do |t|
    t.string 'number'
    t.integer 'stock_location_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_inventory_units', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
    t.string 'state'
  ...
  create_table 'spree_line_item_actions', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                          force: :cascade do |t|
  ...
  create_table 'spree_line_items', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                   force: :cascade do |t|
    t.integer 'variant_id'
    t.integer 'order_id'
  ...
  create_table 'spree_log_entries', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
    t.string 'source_type'
    t.integer 'source_id'
    t.text 'details'
  ...
  create_table 'spree_option_type_prototypes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                               force: :cascade do |t|
  ...
  create_table 'spree_option_types', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                     force: :cascade do |t|
  ...
  create_table 'spree_option_values', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                      force: :cascade do |t|
    t.integer 'position'
    t.string 'name'
  ...
  create_table 'spree_option_values_variants', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                               force: :cascade do |t|
    t.integer 'variant_id'
  ...
  create_table 'spree_order_mutexes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                      force: :cascade do |t|
    t.integer 'order_id', null: false
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_orders_promotions', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                          force: :cascade do |t|
    t.integer 'order_id'
  ...
  create_table 'spree_payment_capture_events', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                               force: :cascade do |t|
  ...
  create_table 'spree_payment_methods', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
    t.string 'type'
    t.string 'name'
    t.text 'description'
  ...
  create_table 'spree_preferences', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
    t.text 'value'
    t.string 'key'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_product_option_types', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                             force: :cascade do |t|
    t.integer 'position'
  ...
  create_table 'spree_product_promotion_rules', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                force: :cascade do |t|
    t.integer 'product_id'
  ...
  create_table 'spree_product_properties', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                           force: :cascade do |t|
    t.string 'value'
    t.integer 'product_id'
  ...
  create_table 'spree_products_taxons', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
    t.integer 'product_id'
    t.integer 'taxon_id'
    t.integer 'position'
  ...
  create_table 'spree_promotion_action_line_items', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                    force: :cascade do |t|
  ...
  create_table 'spree_promotion_actions', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                          force: :cascade do |t|
    t.integer 'promotion_id'
    t.integer 'position'
    t.string 'type'
  ...
  create_table 'spree_promotion_categories', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                             force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_promotion_code_batches', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                               force: :cascade do |t|
  ...
  create_table 'spree_promotion_codes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
    t.integer 'promotion_id', null: false
  ...
  create_table 'spree_promotion_rule_taxons', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                              force: :cascade do |t|
    t.integer 'taxon_id'
    t.integer 'promotion_rule_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_promotion_rules', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
    t.integer 'promotion_id'
  ...
  create_table 'spree_promotion_rules_users', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                              force: :cascade do |t|
    t.integer 'user_id'
    t.integer 'promotion_rule_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_promotions', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                   force: :cascade do |t|
  ...
  create_table 'spree_properties', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                   force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'spree_property_prototypes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                            force: :cascade do |t|
    t.integer 'prototype_id'
    t.integer 'property_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_prototype_taxons', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                         force: :cascade do |t|
    t.integer 'taxon_id'
    t.integer 'prototype_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_prototypes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                   force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_refund_reasons', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                       force: :cascade do |t|
    t.string 'name'
    t.boolean 'active', default: true
  ...
  create_table 'spree_reimbursement_credits', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                              force: :cascade do |t|
    t.decimal 'amount', precision: 10, scale: 2, default: '0.0', null: false
    t.integer 'reimbursement_id'
  ...
  create_table 'spree_reimbursement_types', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                            force: :cascade do |t|
    t.string 'name'
    t.boolean 'active', default: true
    t.boolean 'mutable', default: true
  ...
  create_table 'spree_reimbursements', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                       force: :cascade do |t|
    t.string 'number'
  ...
  create_table 'spree_return_authorizations', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                              force: :cascade do |t|
    t.string 'number'
    t.string 'state'
    t.integer 'order_id'
  ...
  create_table 'spree_return_items', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                     force: :cascade do |t|
  ...
  create_table 'spree_return_reasons', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                       force: :cascade do |t|
    t.string 'name'
    t.boolean 'active', default: true
    t.boolean 'mutable', default: true
  ...
  create_table 'spree_roles_users', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
    t.integer 'role_id'
    t.integer 'user_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_shipping_categories', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                            force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_shipping_method_categories', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                   force: :cascade do |t|
  ...
  create_table 'spree_shipping_method_stock_locations', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                        force: :cascade do |t|
    t.integer 'shipping_method_id'
    t.integer 'stock_location_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_shipping_method_zones', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                              force: :cascade do |t|
    t.integer 'shipping_method_id'
    t.integer 'zone_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_shipping_methods', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                         force: :cascade do |t|
    t.string 'name'
    t.datetime 'deleted_at'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_shipping_rate_taxes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                            force: :cascade do |t|
  ...
  create_table 'spree_shipping_rates', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                       force: :cascade do |t|
    t.integer 'shipment_id'
    t.integer 'shipping_method_id'
  ...
  create_table 'spree_state_changes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                      force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'spree_stock_items', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                    force: :cascade do |t|
    t.integer 'stock_location_id'
    t.integer 'variant_id'
  ...
  create_table 'spree_stock_locations', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_stock_movements', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                        force: :cascade do |t|
  ...
  create_table 'spree_store_credit_categories', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_store_credit_events', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                            force: :cascade do |t|
  ...
  create_table 'spree_store_credit_types', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                           force: :cascade do |t|
    t.string 'name'
    t.integer 'priority'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_store_credits', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                      force: :cascade do |t|
    t.integer 'user_id'
  ...
  create_table 'spree_store_payment_methods', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                              force: :cascade do |t|
  ...
  create_table 'spree_tax_categories', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                       force: :cascade do |t|
    t.string 'name'
    t.string 'description'
  ...
  create_table 'spree_tax_rate_tax_categories', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                force: :cascade do |t|
  ...
  create_table 'spree_taxonomies', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                   force: :cascade do |t|
    t.string 'name', null: false
    t.datetime 'created_at', precision: 6
    t.datetime 'updated_at', precision: 6
  ...
  create_table 'spree_unit_cancels', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                     force: :cascade do |t|
  ...
  create_table 'spree_user_addresses', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                       force: :cascade do |t|
  ...
  create_table 'spree_user_stock_locations', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                             force: :cascade do |t|
    t.integer 'user_id'
    t.integer 'stock_location_id'
    t.datetime 'created_at', precision: 6
  ...
  create_table 'spree_variant_property_rule_conditions', id: :integer,
                                                         options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3', force: :cascade do |t|
    t.integer 'option_value_id'
  ...
  create_table 'spree_variant_property_rule_values', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                     force: :cascade do |t|
    t.text 'value'
    t.integer 'position', default: 0
    t.integer 'property_id'
  ...
  create_table 'spree_variant_property_rules', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                               force: :cascade do |t|
    t.integer 'product_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  create_table 'spree_wallet_payment_sources', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                               force: :cascade do |t|
    t.integer 'user_id', null: false
  ...
  create_table 'spree_zone_members', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                     force: :cascade do |t|
